...
export declare class Widget extends NodeWrapper implements IDisposable, IMessageHandler {
     ...
     */
    static titleProperty: Property<Widget, string>;
    /**
     ...
     * **See also:** [[titleIcon]]
     */
    static titleIconProperty: Property<Widget, string>;
    /**
     ...
     */
    static titleEditableHintProperty: Property<Widget, boolean>;
    /**
 ...
 */
export declare class ChangeTitleMessage extends Message {
    /**
 ...
 */
export interface IDragMimeData {
    /**
