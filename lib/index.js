 ...
 */
exports.WIDGET_MIME_TYPE = 'application/x-phosphor-widget';
var WIDGET_MIME_DATA = 'truthy';
/**
...
var Widget = (function (_super) {
    ...
    Widget.clearDragMimeData = function (event) {
        dragFactory = null;
    };
    Widget.getDragMimeData = function (event) {
        if (event.dataTransfer.getData(exports.WIDGET_MIME_TYPE) && dragFactory) {
            return dragFactory;
        }
        else {
            return null;
    ...
    Widget.setDragMimeData = function (event, factory) {
        if (!factory) {
            return;
        }
        dragFactory = factory;
        event.dataTransfer.setData(exports.WIDGET_MIME_TYPE, WIDGET_MIME_DATA);
    };
    /**
    ...
    Object.defineProperty(Widget.prototype, "titleIcon", {
        /**
    ...
    Object.defineProperty(Widget.prototype, "titleEditableHint", {
        /**
    ...
    Object.defineProperty(Widget.prototype, "closableHint", {
        /**
     ...
     */
    Widget.prototype.onChangeTitle = function (msg) {
     ...
     */
    Widget.titleProperty = new phosphor_properties_1.Property({
        value: '',
    });
    /**
     ...
     * **See also:** [[titleIcon]]
     */
    Widget.titleIconProperty = new phosphor_properties_1.Property({
        value: '',
    });
    /**
     ...
     */
    Widget.titleEditableHintProperty = new phosphor_properties_1.Property({
        value: false,
    });
    /**
     ...
     */
    Widget.closableHintProperty = new phosphor_properties_1.Property({
        value: false,
    });
    return Widget;
 ...
 */
var ChangeTitleMessage = (function (_super) {
    __extends(ChangeTitleMessage, _super);
    /**
     * Construct a new change title message.
     *
     * @param title - The title to use for the widget.
     */
    function ChangeTitleMessage(title) {
        _super.call(this, 'change-title');
        this._title = title;
    }
    Object.defineProperty(ChangeTitleMessage.prototype, "title", {
        /**
    ...
    return ChangeTitleMessage;
})(phosphor_messaging_1.Message);
exports.ChangeTitleMessage = ChangeTitleMessage;
/**
...
function sendToAll(widgets, msg) {
    for (var _i = 0; _i < widgets.length; _i++) {
        ...
        phosphor_messaging_1.sendMessage(widget, msg);
    }
}
/**
